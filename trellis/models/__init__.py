...
__attributes = {
    ...
    'SLatEncoderWithDownsampleV3': 'structured_latent_vae',
    'ElasticSLatEncoderWithDownsampleV3': 'structured_latent_vae',

    'SLatGaussianDecoderWithUpsampleV3': 'structured_latent_vae',
    'ElasticSLatGaussianDecoderWithUpsampleV3': 'structured_latent_vae',

    "SparseStructureFlowMixCondModel": "sparse_structure_flow",
    "SparseStructureFlowAlternateModel": "sparse_structure_flow",

    "SLatMeshDecoderV3U": 'structured_latent_vae',
