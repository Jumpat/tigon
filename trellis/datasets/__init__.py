...
__attributes = {
    ...
    'InterleaveConditionedSparseStructureLatent': 'sparse_structure_latent',
    'InterleaveConditionedSLat': 'structured_latent',

    'InterleaveConditionedSLatUnify': 'sparse_structure_latent_e2e',
    'ImageConditionedSLatUnify': 'sparse_structure_latent_e2e',
    'TextConditionedSLatUnify': 'sparse_structure_latent_e2e',
    # 'InterleaveConditionedDualBranchSLatUnify': 'sparse_structure_latent_e2e',
}
