...
__attributes = {
    ...
    'InterleaveConditionedFlowMatchingCFGTrainer': 'flow_matching.flow_matching',

    'InterleaveConditionedDINOCLIPFlowMatchingCFGTrainerE2E': 'flow_matching.flow_matching_e2e',
