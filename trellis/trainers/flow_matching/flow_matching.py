...
class InterleaveConditionedFlowMatchingCFGTrainer(InterleaveConditionedMixin, FlowMatchingCFGTrainer):
    pass

class InterleaveConditionedDINOCLIPFlowMatchingCFGTrainer(InterleaveConditionedDINOCLIPMixin, FlowMatchingCFGTrainer):
    pass